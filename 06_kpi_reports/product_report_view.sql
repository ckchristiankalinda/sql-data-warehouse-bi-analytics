...
WITH base_query AS (
/*--------------------------------------------------------------------
1. Base dataset: link sales with products
--------------------------------------------------------------------*/
SELECT
    f.order_number,
    f.order_date,
...
SELECT
    ...
    -- Product segmentation (business performance)
    CASE
    ...
    -- KPI: revenue per order
    CASE
        WHEN total_orders = 0 THEN 0
        ELSE total_sales / total_orders
    END AS avg_order_revenue,

    -- KPI: monthly revenue contribution
    CASE
